...
const (
	BarService_CreateBar_FullMethodName = "/bar.v1.BarService/CreateBar"
	BarService_GetBar_FullMethodName    = "/bar.v1.BarService/GetBar"
	BarService_ListBars_FullMethodName  = "/bar.v1.BarService/ListBars"
	BarService_UpdateBar_FullMethodName = "/bar.v1.BarService/UpdateBar"
	BarService_DeleteBar_FullMethodName = "/bar.v1.BarService/DeleteBar"
)
...
//
// BarService provides CRUD operations for Bar resources.
type BarServiceClient interface {
	...
	// GetBar retrieves a Bar resource by ID.
