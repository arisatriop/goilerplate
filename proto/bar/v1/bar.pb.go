...
// CreateBarResponse is the response message for CreateBar.
...
// GetBarResponse is the response message for GetBar.
...
func (x *DeleteBarRequest) Reset() {
	*x = DeleteBarRequest{}
	mi := &file_proto_bar_v1_bar_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBarRequest) Descriptor() ([]byte, []int) {
	return file_proto_bar_v1_bar_proto_rawDescGZIP(), []int{9}
}
...
func (x *DeleteBarResponse) Reset() {
	*x = DeleteBarResponse{}
	mi := &file_proto_bar_v1_bar_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBarResponse) Descriptor() ([]byte, []int) {
	return file_proto_bar_v1_bar_proto_rawDescGZIP(), []int{10}
}
...
const file_proto_bar_v1_bar_proto_rawDesc = "" +
	"\n" +
	"\x16proto/bar/v1/bar.proto\x12\x06bar.v1\";\n" +
	"\x03Bar\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x10\n" +
	"\x03bar\x18\x03 \x01(\tR\x03bar\"8\n" +
	"\x10CreateBarRequest\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x10\n" +
	"\x03bar\x18\x02 \x01(\tR\x03bar\"\x13\n" +
	"\x11CreateBarResponse\"\x1f\n" +
	"\rGetBarRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"/\n" +
	"\x0eGetBarResponse\x12\x1d\n" +
	"\x03bar\x18\x01 \x01(\v2\v.bar.v1.BarR\x03bar\"U\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x10\n" +
	"\x03bar\x18\x03 \x01(\tR\x03bar\"\x13\n" +
	"\x11UpdateBarResponse\"\x12\n" +
	"\x10DeleteBarRequest\"\x13\n" +
	"\x11DeleteBarResponse2\xca\x02\n" +
	"\n" +
	"BarService\x12@\n" +
	"\tCreateBar\x12\x18.bar.v1.CreateBarRequest\x1a\x19.bar.v1.CreateBarResponse\x127\n" +
	"\x06GetBar\x12\x15.bar.v1.GetBarRequest\x1a\x16.bar.v1.GetBarResponse\x12=\n" +
...
var file_proto_bar_v1_bar_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_bar_v1_bar_proto_goTypes = []any{
	(*Bar)(nil),               // 0: bar.v1.Bar
	(*CreateBarRequest)(nil),  // 1: bar.v1.CreateBarRequest
	(*CreateBarResponse)(nil), // 2: bar.v1.CreateBarResponse
	(*GetBarRequest)(nil),     // 3: bar.v1.GetBarRequest
	(*GetBarResponse)(nil),    // 4: bar.v1.GetBarResponse
	(*ListBarsRequest)(nil),   // 5: bar.v1.ListBarsRequest
	(*ListBarsResponse)(nil),  // 6: bar.v1.ListBarsResponse
	(*UpdateBarRequest)(nil),  // 7: bar.v1.UpdateBarRequest
	(*UpdateBarResponse)(nil), // 8: bar.v1.UpdateBarResponse
	(*DeleteBarRequest)(nil),  // 9: bar.v1.DeleteBarRequest
	(*DeleteBarResponse)(nil), // 10: bar.v1.DeleteBarResponse
}
var file_proto_bar_v1_bar_proto_depIdxs = []int32{
	0,  // 0: bar.v1.GetBarResponse.bar:type_name -> bar.v1.Bar
	0,  // 1: bar.v1.ListBarsResponse.bars:type_name -> bar.v1.Bar
	1,  // 2: bar.v1.BarService.CreateBar:input_type -> bar.v1.CreateBarRequest
	3,  // 3: bar.v1.BarService.GetBar:input_type -> bar.v1.GetBarRequest
	5,  // 4: bar.v1.BarService.ListBars:input_type -> bar.v1.ListBarsRequest
	7,  // 5: bar.v1.BarService.UpdateBar:input_type -> bar.v1.UpdateBarRequest
	9,  // 6: bar.v1.BarService.DeleteBar:input_type -> bar.v1.DeleteBarRequest
	2,  // 7: bar.v1.BarService.CreateBar:output_type -> bar.v1.CreateBarResponse
	4,  // 8: bar.v1.BarService.GetBar:output_type -> bar.v1.GetBarResponse
	6,  // 9: bar.v1.BarService.ListBars:output_type -> bar.v1.ListBarsResponse
	8,  // 10: bar.v1.BarService.UpdateBar:output_type -> bar.v1.UpdateBarResponse
	10, // 11: bar.v1.BarService.DeleteBar:output_type -> bar.v1.DeleteBarResponse
