...
type Usecase interface {
	Create(ctx context.Context, entity *Example2) error
	Update(ctx context.Context, entity *Example2) error
	Delete(ctx context.Context, entity *Example2) error

	GetByID(ctx context.Context, id string) (*Example2, error)
	GetList(ctx context.Context, filter *Filter) ([]*Example2, error)
...
func (uc *usecase) Create(ctx context.Context, entity *Example2) error {
...
func (uc *usecase) Update(ctx context.Context, entity *Example2) error {
...
func (uc *usecase) Delete(ctx context.Context, entity *Example2) error {
	existing, err := uc.repo.GetExampleByID(ctx, entity.ID)
	if err != nil {
...
func (uc *usecase) GetByID(ctx context.Context, id string) (*Example2, error) {
...
func (uc *usecase) GetList(ctx context.Context, filter *Filter) ([]*Example2, error) {
	if filter == nil {
		filter = &Filter{}
	}
...
// func (uc *usecase) BulkCreate(ctx context.Context, entities []*Example2) error {
