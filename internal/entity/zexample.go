...
type Example struct {
	...
	NumericNull     *decimal.Decimal `gorm:"column:numeric_null" json:"numeric_null"`
	...
	NumericNotNull     decimal.Decimal `gorm:"column:numeric_not_null" json:"numeric_not_null"`
