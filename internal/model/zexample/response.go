...
type GetResponse struct {
	...
	CustomeField1      string           `json:"custome_field_1"`
	CustomeField2      string           `json:"custome_field_2"`
	CustomeField3      string           `json:"custome_field_3"`
	CustomeField4      string           `json:"custome_field_4"`
	CustomeField5      string           `json:"custome_field_5"`
}
