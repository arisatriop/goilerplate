...
CREATE TABLE user_permissions (
    ...
    is_granted BOOLEAN DEFAULT TRUE, -- TRUE = explicitly granted, FALSE = explicitly revoked
    ...
    updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, -- Timestamp when relationship was last updated
    updated_by VARCHAR(255) NOT NULL, -- User who last updated this relationship
